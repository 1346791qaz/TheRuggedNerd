  ...
  const SEARCH_ITEMS = [
    {
      ...
      content:
        "Annual family road trip to the Rockies with trail hikes, mountain views, and travel trailer adventure notes.",
      url: "blog/rocky-mountain-trip.html",
      date: "2025-02-14",
      tags: [
        "rocky mountain",
        "colorado",
    ...
    },
    {
      id: "blog-rv-types",
      type: "blog",
      title: "The Rugged Nerd's Guide to RVs: Why We Chose a Travel Trailer",
      content:
        "Comparison of RV types from pop-ups to Class A motorhomes and why a travel trailer fits this family's adventure style.",
      url: "blog/rv-wifi-setup.html",
      date: "2025-01-20",
      tags: ["rv", "travel trailer", "camping", "family", "buying guide"],
    },
    {
      id: "blog-loyd-park",
      type: "blog",
      title: "Loyd Park at Joe Pool Lake, Grand Prairie, TX",
      content:
        "Campground review covering lakeside campsites, amenities, nearby city access, and overall family-friendly experience.",
      url: "blog/campground-review-zion.html",
      date: "2024-12-05",
      tags: ["campground", "review", "texas", "loyd park", "joe pool lake"],
    },
